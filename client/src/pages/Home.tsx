...
export default function Home() {
  ...
  return (
    <main className="dark min-h-screen flex flex-col gap-4 justify-center items-center bg-neutral-950 text-white p-4">
      ...
      <div className="w-full overflow-auto flex grow items-center justify-center p-4 border rounded-xl border-neutral-800">
        <Resizable
      ...
      <Card className="p-6 w-fit bg-neutral-900/90 backdrop-blur border-neutral-800">
      ...
      <footer className="text-center text-neutral-500 text-sm mt-4">
        <p>
          Made with ❤️ by{" "}
          <a
          ...
          <span className="text-purple-400 font-semibold">Zayeef Zahid</span>
        </p>
      </footer>
    </main>
  );
